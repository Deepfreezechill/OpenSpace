...
from scion.grounding.backends.mcp.transport.connectors.base import (
    DEFAULT_TOOL_CALL_MAX_RETRIES,
    DEFAULT_TOOL_CALL_RETRY_DELAY,
    MCPBaseConnector,
)
from scion.grounding.backends.mcp.transport.task_managers import (
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(self.timeout), headers=headers) as client:
            payload = {
                ...
                "params": {
                    ...
                    "capabilities": {},
                    "clientInfo": {"name": "Scion", "version": "2.0.0"},
                },
            }
