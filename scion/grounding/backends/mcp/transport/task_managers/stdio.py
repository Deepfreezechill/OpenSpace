...
from scion.grounding.core.transport.task_managers import (
...
class FilteredStderrWrapper(io.TextIOBase):
    ...
    def _process_line(self, line: str):
        ...
        if (
            ...
            or line.strip().startswith("Exception Group Traceback (most recent call last)")
            or line.strip().startswith("BaseExceptionGroup:")
            or line.strip().startswith("ExceptionGroup:")
        ):
            self._in_traceback = True
            self._traceback_lines = [line]
