...
description: Search for reusable skills across Scion's local registry and cloud community. Reusing proven skills saves tokens, improves reliability, and extends your capabilities beyond built-in tools.
---

# Skill Discovery

Discover and browse skills from Scion's local and cloud skill library.
...
- You need to decide: handle a task yourself, or delegate to Scion
