#!/usr/bin/env python3
"""Download a skill from the Scion cloud platform.

Usage:
    scion-download-skill --skill-id "weather__imp_abc12345" --output-dir ./skills/
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="scion-download-skill",
        description="Download a skill from Scion's cloud community",
    )
