...
class ScreenshotHelper:
    ...
    def compare_screenshots(self, path1: str, path2: str) -> float:
        ...
        try:
            ...
            stat = diff.histogram()
            sum_of_squares = reduce(operator.add, map(lambda h, i: h * (i**2), stat, range(len(stat))))
    ...
    def annotate_screenshot(self, input_path: str, output_path: str, annotations: list) -> bool:
        """
