"""CLI Display utilities for Scion startup and interaction"""

from scion.tool_layer import ScionConfig
from scion.utils.display import Box, BoxStyle, colorize
...
class CLIDisplay:
    ...
    def print_banner():
        ...
        title = colorize("Scion", "c", bold=True)
    ...
    @staticmethod
    def print_configuration(config: ScionConfig):
        box = Box(width=70, style=BoxStyle.ROUNDED, color="bl")

        print(
            box.text_line(colorize("◉ System Configuration", "c", bold=True), align="center", indent=4, text_color="")
        )
    ...
    def print_initialization_progress(steps: list, show_header: bool = True):
        ...
        if show_header:
            print(
                box.text_line(
                    colorize("► Initializing Components", "g", bold=True), align="center", indent=4, text_color=""
                )
            )
            print(box.separator_line(indent=4))
    ...
    def print_result_summary(result: dict):
        ...
        if result.get("user_response"):
            ...
            print(response_box.text_line(colorize("◈ Result", "g", bold=True), align="center", indent=4, text_color=""))
    ...
    def print_interactive_header():
        ...
        print(box.text_line(colorize("⌨ Interactive Mode", "c", bold=True), align="center", indent=4, text_color=""))
        print(box.separator_line(indent=4))
    ...
    def print_system_ready():
        box = Box(width=70, style=BoxStyle.ROUNDED, color="g")
        print(box.text_line(colorize("◈ System Ready", "g", bold=True), align="center", indent=4, text_color=""))
        print(box.separator_line(indent=4))
        print(box.text_line("", indent=4, text_color=""))
    ...
    def print_help():
        ...
        print()
        print(box.text_line(colorize("Available Commands", "y", bold=True), align="center", indent=4, text_color=""))
        print(box.separator_line(indent=4))
