...
def _get_cloud_client():
    ...
    from scion.cloud.auth import get_openspace_auth
    from scion.cloud.client import OpenSpaceClient
...
async def fix_skill(
    ...
    """
    try:
        from scion.skill_engine.evolver import EvolutionContext, EvolutionTrigger
