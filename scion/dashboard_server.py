...
from scion.recording.action_recorder import analyze_agent_actions, load_agent_actions
from scion.recording.utils import load_recording_session
...
def create_app() -> Flask:
    ...
    def serve_frontend(path: str) -> Any:
        ...
        return jsonify(
            {
                "message": "Scion dashboard API is running.",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scion dashboard API server")
