"""Sliding-window rate limiter for Scion servers.
...
Environment variables:
  SCION_RATE_LIMIT_PER_TOKEN  — requests per window per identity (default: 60)
  SCION_RATE_LIMIT_PER_IP     — requests per window per IP (default: 30)
  SCION_RATE_LIMIT_WINDOW     — window size in seconds (default: 60)
"""
...
RATE_LIMIT_PER_TOKEN_ENV = "SCION_RATE_LIMIT_PER_TOKEN"
RATE_LIMIT_PER_IP_ENV = "SCION_RATE_LIMIT_PER_IP"
RATE_LIMIT_WINDOW_ENV = "SCION_RATE_LIMIT_WINDOW"
