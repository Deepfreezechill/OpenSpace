...
def format_trajectory_for_export(trajectory: List[Dict[str, Any]], format_type: str = "compact") -> str:
...
def analyze_trajectory(trajectory: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    """
    if not trajectory:
        return {"total_steps": 0, "success_rate": 0.0, "backends": {}, "action_types": {}}
...
def load_recording_session(recording_dir: str) -> Dict[str, Any]:
    ...
    session = {"trajectory": [], "metadata": None, "plans": [], "decisions": [], "statistics": {}}
