"""Prometheus-compatible metrics for Scion.
...
class MetricsRegistry:
    """Container for all Scion Prometheus metrics.
    ...
    def __init__(self, registry: CollectorRegistry | None = None) -> None:
        ...
        self.execution_latency = Histogram(
            "scion_execution_latency_seconds",
        ...
        self.evolution_latency = Histogram(
            "scion_evolution_latency_seconds",
        ...
        self.tool_call_latency = Histogram(
            "scion_tool_call_latency_seconds",
