"""scion.agents.grounding — GroundingAgent subsystem package.
...
The class itself remains in ``scion.agents.grounding_agent`` as a thin
...
from scion.agents.grounding.execution import process
