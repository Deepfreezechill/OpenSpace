...
from openspace.grounding.core.types import BackendType, SecurityPolicy, SessionConfig
...
class ToolQualityConfig(BaseModel):
    ...
    cache_dir: Optional[str] = Field(
        None, description="Directory for quality cache. None means use default <project_root>/.openspace/tool_quality"
    )
...
class SkillConfig(BaseModel):
    ...
    skill_dirs: List[str] = Field(
        default_factory=list, description="Extra skill directories. Built-in openspace/skills/ is always included."
    )
