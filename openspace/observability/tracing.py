"""Structured execution tracing for OpenSpace.
...
Integrates with ``openspace.domain.logging`` context variables when
available, carrying ``task_id`` and ``correlation_id`` into every span.

Usage::

    from openspace.observability.tracing import tracer, trace_async
...
_current_trace: contextvars.ContextVar[Optional[Trace]] = contextvars.ContextVar(
    "openspace_trace", default=None
)
_current_span: contextvars.ContextVar[Optional[Span]] = contextvars.ContextVar(
    "openspace_span", default=None
)
