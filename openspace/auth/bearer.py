"""Shared-secret bearer token authentication for OpenSpace servers.
...
Usage:
    Set OPENSPACE_MCP_BEARER_TOKEN in your environment before starting
...
BEARER_TOKEN_ENV = "OPENSPACE_MCP_BEARER_TOKEN"
MIN_TOKEN_LENGTH = 32
        ...
        await send(
            {
                ...
                "headers": [
                    ...
                    [b"www-authenticate", b'Bearer realm="openspace-mcp"'],
