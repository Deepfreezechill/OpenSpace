...
class TestProtocolCompliance:
    ...
    def test_sandbox_has_required_methods(self):
        ...
        from scion.grounding.core.security.sandbox import BaseSandbox
    ...
    def test_telemetry_has_required_methods(self):
        ...
        try:
            from scion.utils.telemetry.telemetry import Telemetry
        except ImportError:
    ...
    def test_llm_client_has_complete(self):
        ...
        try:
            from scion.llm.client import LLMClient
        except ImportError:
    ...
    def test_policy_engine_has_required_methods(self):
        ...
        from scion.grounding.core.security.policies import SecurityPolicyManager
...
class TestTaskTypes:
    ...
    def test_task_request_frozen(self):
        from scion.domain.types import TaskRequest
    ...
    def test_task_result_frozen(self):
        from scion.domain.types import TaskResult
    ...
    def test_task_result_roundtrip(self):
        from scion.domain.types import TaskResult, ToolExecution
...
class TestSkillTypes:
    ...
    def test_skill_identity_hashable(self):
        from scion.domain.types import SkillIdentity
    ...
    def test_skill_manifest_frozen(self):
        from scion.domain.types import SkillManifest
...
class TestEvolutionTypes:
    ...
    def test_evolution_request_frozen(self):
        from scion.domain.types import EvolutionRequest
    ...
    def test_evolution_result_frozen(self):
        from scion.domain.types import EvolutionResult
...
class TestAnalysisTypes:
    ...
    def test_execution_analysis_snapshot_frozen(self):
        from scion.domain.types import ExecutionAnalysisSnapshot
    ...
    def test_analysis_snapshot_nested_immutability(self):
        from scion.domain.types import (
...
class TestSearchTypes:
    ...
    def test_search_result_frozen(self):
        from scion.domain.types import SkillSearchResult
    ...
    def test_search_response_frozen(self):
        from scion.domain.types import SkillSearchResponse, SkillSearchResult
...
class TestSecurityTypes:
    ...
    def test_sandbox_policy_frozen(self):
        from scion.domain.types import SandboxPolicy
    ...
    def test_capability_lease_frozen(self):
        from scion.domain.types import CapabilityLease
...
class TestToolTypes:
    ...
    def test_tool_descriptor_frozen(self):
        from scion.domain.types import ToolDescriptor
    ...
    def test_tool_call_result_frozen(self):
        from scion.domain.types import ToolCallResult
...
class TestEnumConsolidation:
    ...
    def test_re_exported_enums_match_originals(self):
        ...
        from scion.domain.enums import EvolutionType as DomainEvType
        from scion.skill_engine.types import EvolutionType as OrigEvType
        ...
        from scion.domain.enums import SkillCategory as DomainSC
        from scion.skill_engine.types import SkillCategory as OrigSC

        assert DomainSC is OrigSC

    def test_new_task_status_enum(self):
        from scion.domain.enums import TaskStatus
    ...
    def test_new_trust_tier_enum(self):
        from scion.domain.enums import TrustTier
    ...
    def test_new_skill_status_enum(self):
        from scion.domain.enums import SkillStatus
    ...
    def test_new_mcp_error_code_enum(self):
        from scion.domain.enums import MCPErrorCode
    ...
    def test_search_mode_enum(self):
        from scion.domain.enums import SearchMode

        assert SearchMode.HYBRID.value == "hybrid"
        assert SearchMode.SEMANTIC.value == "semantic"

    def test_patch_type_enum(self):
        from scion.domain.enums import PatchType
...
class TestDeepFreeze:
    ...
    def test_deep_freeze_dict(self):
        from scion.domain.types import _deep_freeze
...
class TestAllTypesFrozen:
    ...
    def test_all_domain_types_are_frozen(self):
        import scion.domain.types as mod
